...
export class FindAllSubComponentDto extends FindAllDto {
  @ApiPropertyOptional({
    description:
      'Comma-separated relations (e.g., component,measurementScales)',
    type: String,
  })
  @IsArrayContains(['component', 'measurementScales'])
  @IsString({ each: true })
  @IsOptional()
  @Type(() => String)
...
export class FindOneSubComponentDto {
  @ApiPropertyOptional({
    description:
      'Comma-separated relations (e.g., component,measurementScales)',
    type: String,
