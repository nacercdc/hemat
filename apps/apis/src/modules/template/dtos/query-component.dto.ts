...
export class FindAllComponentDto extends FindAllDto {
  @ApiPropertyOptional({
    description: 'Comma-separated relations (e.g., domain)',
    type: String,
  })
  @IsArrayContains(['domain', 'sub_components'])
  @IsString({ each: true })
  @IsOptional()
  @Type(() => String)
