...
export class Migration1747747507844 implements MigrationInterface {
    name = 'Migration1747747507844'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "components" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "code" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "domainId" uuid NOT NULL, CONSTRAINT "UQ_5409124de81d8d24ef76b4a5315" UNIQUE ("code"), CONSTRAINT "PK_0d742661c63926321b5f5eac1ad" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_4ee9fc4c57cce74443dca8d033" ON "components" ("domainId") `);
        await queryRunner.query(`CREATE TABLE "sub_components" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "code" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "componentId" uuid NOT NULL, CONSTRAINT "UQ_3f78a1f320640def3b4c2d98b1d" UNIQUE ("code"), CONSTRAINT "PK_d403367627d1958909a22da2ef5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_520ce9d3c21e8c923594e41a9b" ON "sub_components" ("componentId") `);
        await queryRunner.query(`CREATE TABLE "measurement_scale_sub_components" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "subComponentId" uuid NOT NULL, "measurementScaleId" uuid NOT NULL, "description" text NOT NULL, CONSTRAINT "UQ_f782449124e0ede15ff78ffa21f" UNIQUE ("subComponentId", "measurementScaleId"), CONSTRAINT "PK_28c76639b09fb54a495a42dff2d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "assessment_sub_components" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "code" character varying NOT NULL, "name" character varying NOT NULL, "description" text NOT NULL, "assessmentId" uuid NOT NULL, "componentId" uuid NOT NULL, "translations" jsonb NOT NULL, "messurmentScalesId" uuid, CONSTRAINT "UQ_3e9b7879bb3b0468884d7b686b7" UNIQUE ("code"), CONSTRAINT "PK_8f71c28168394a25295a8b7153d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "countries" ("iso2" character varying(2) NOT NULL, "name" character varying(100) NOT NULL, "numericCode" character varying(3) NOT NULL, "phoneCode" character varying(10) NOT NULL, "native" character varying(100) NOT NULL, "frenchTranslation" character varying(100) NOT NULL, "latitude" character varying(20) NOT NULL, "longitude" character varying(20) NOT NULL, "emoji" character varying(10) NOT NULL, "emojiU" character varying(20) NOT NULL, "description" text, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_9706e3c52695ce44a202f24c26b" PRIMARY KEY ("iso2"))`);
        await queryRunner.query(`CREATE TABLE "assessments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "userId" uuid NOT NULL, "name" character varying NOT NULL, "description" text NOT NULL, "countryCode" character varying NOT NULL, "organization" text, "date" TIMESTAMP NOT NULL, "domainsId" uuid, CONSTRAINT "PK_a3442bd80a00e9111cefca57f6c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "assessment_measurement_scale" ADD CONSTRAINT "FK_39839f35b3949714cdf9ab98e20" FOREIGN KEY ("subComponentsId") REFERENCES "assessment_measurement_scale_sub_components"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "assessment_sub_components" ADD CONSTRAINT "FK_da2b5f1bfa7605286c06ab6b8d2" FOREIGN KEY ("messurmentScalesId") REFERENCES "assessment_measurement_scale_sub_components"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "assessments" ADD CONSTRAINT "FK_9ab7298e30eb3ca865d6d96ff8b" FOREIGN KEY ("countryCode") REFERENCES "countries"("iso2") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "assessments" ADD CONSTRAINT "FK_50ab07c5f4086a02f7e17ed0935" FOREIGN KEY ("domainsId") REFERENCES "assessment-domains"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "assessments" DROP CONSTRAINT "FK_50ab07c5f4086a02f7e17ed0935"`);
        ...
        await queryRunner.query(`ALTER TABLE "assessment_sub_components" DROP CONSTRAINT "FK_da2b5f1bfa7605286c06ab6b8d2"`);
        ...
        await queryRunner.query(`ALTER TABLE "assessment_measurement_scale" DROP CONSTRAINT "FK_39839f35b3949714cdf9ab98e20"`);
