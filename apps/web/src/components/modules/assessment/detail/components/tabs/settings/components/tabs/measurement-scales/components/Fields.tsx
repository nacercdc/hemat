...
import type { MeasurementScaleFormData } from "./Content";
...
interface Props {
  control: Control<MeasurementScaleFormData>;
  selectedLanguages: Language[];
  watch: UseFormWatch<MeasurementScaleFormData>;
  errors: FieldErrors<MeasurementScaleFormData>;
}
