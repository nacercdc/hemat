...
import type { AssessmentDomainFormData } from "./Content";
...
interface Props {
  control: Control<AssessmentDomainFormData>;
  selectedLanguages: LanguageCreate[];
  watch: UseFormWatch<AssessmentDomainFormData>;
  errors: FieldErrors<AssessmentDomainFormData>;
}
