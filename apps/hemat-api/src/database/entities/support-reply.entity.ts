...
export class SupportReply extends BaseEntityWithTimestamp {
  @ApiProperty({ description: 'Support ticket', type: () => Support })
  @ManyToOne(() => Support, (support) => support.replies, { nullable: false, onDelete: 'CASCADE' })
  support: Support;
  ...
  @Column({ type: 'enum', enum: SupportVisibilityEnum, default: SupportVisibilityEnum.PUBLIC })
  ...
  @Column({ type: 'enum', enum: SupportPriorityEnum, default: SupportPriorityEnum.NORMAL })
