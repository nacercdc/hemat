...
export class Migration1754570912678 implements MigrationInterface {
    name = 'Migration1754570912678'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "assessment_measurement_scale_sub_components" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "subComponentId" uuid NOT NULL, "measurementScaleId" uuid NOT NULL, "description" text NOT NULL, "templateMeasurementScaleSubComponentId" uuid, "translations" jsonb NOT NULL, CONSTRAINT "UQ_27c7b864d23f14b9abf56915209" UNIQUE ("subComponentId", "measurementScaleId"), CONSTRAINT "PK_88798c927611bdebe90d5480e21" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "assessment_measurement_scale" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "description" text NOT NULL, "color" character varying NOT NULL, "rate" integer NOT NULL, "translations" jsonb NOT NULL, "templateMeasurementScaleId" uuid, "assessmentId" uuid NOT NULL, CONSTRAINT "PK_de9b3eeff675381de2999fe4ba2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_06469cb077f7f3261b80fc61d2" ON "assessment_measurement_scale" ("assessmentId") `);
        await queryRunner.query(`CREATE TABLE "assessment_sub_component_roadmaps" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "roadmapId" uuid NOT NULL, "subComponentId" uuid NOT NULL, "measurementScaleId" uuid NOT NULL, "answerId" uuid NOT NULL, "target" character varying(1000) NOT NULL, "currentState" integer NOT NULL, "activities" text NOT NULL, "responsible" character varying(500) NOT NULL, "resources" text NOT NULL, "gapAddressed" text NOT NULL, "startTime" TIMESTAMP NOT NULL, "endTime" TIMESTAMP NOT NULL, CONSTRAINT "UQ_aaf20c420aff3294b4a17d9d45f" UNIQUE ("roadmapId", "subComponentId"), CONSTRAINT "PK_c757a48e21fb96f214eb6dcbe0c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_9cb9e9b068577c71a9caff370e" ON "assessment_sub_component_roadmaps" ("roadmapId") `);
        await queryRunner.query(`CREATE INDEX "IDX_9a3cecc1a9a585a1b7d49f16a7" ON "assessment_sub_component_roadmaps" ("subComponentId") `);
        await queryRunner.query(`CREATE INDEX "IDX_c9a1be04953b281fb165942bc5" ON "assessment_sub_component_roadmaps" ("measurementScaleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_307c8be05afb36bb5225ed2829" ON "assessment_sub_component_roadmaps" ("answerId") `);
        await queryRunner.query(`CREATE TYPE "public"."roadmaps_status_enum" AS ENUM('inprogress', 'completed', 'submitted')`);
        await queryRunner.query(`CREATE TABLE "roadmaps" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "assessmentId" uuid NOT NULL, "userId" uuid NOT NULL, "isPrimary" boolean NOT NULL DEFAULT true, "percentage" double precision NOT NULL DEFAULT '0', "status" "public"."roadmaps_status_enum" NOT NULL DEFAULT 'inprogress', CONSTRAINT "PK_9b0d527f9c64d15405c21e7ca54" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_84a1a1aa1deaa05869eb59eb44" ON "roadmaps" ("assessmentId") `);
        await queryRunner.query(`CREATE INDEX "IDX_29f718c5a5cb41f2266d21ba20" ON "roadmaps" ("userId") `);
        ...
        await queryRunner.query(`CREATE TABLE "assessment-domains" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "code" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "assessmentId" uuid NOT NULL, "translations" jsonb NOT NULL, "templateDomainId" uuid, CONSTRAINT "UQ_6519230210826e954f9dfc1d84f" UNIQUE ("code", "assessmentId"), CONSTRAINT "PK_b02a0aec28def9b31043ff2b679" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_198045c771f5080df0f1625ee4" ON "assessment-domains" ("assessmentId") `);
        await queryRunner.query(`CREATE TABLE "assessment-components" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "code" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "assessmentId" uuid NOT NULL, "translations" jsonb NOT NULL, "templateComponentId" uuid, "domainId" uuid NOT NULL, CONSTRAINT "UQ_783d71a6bf35661603b4e6ed89d" UNIQUE ("code", "assessmentId"), CONSTRAINT "PK_5023a6fea16fb07c37f20cb3872" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "assessment_sub_components" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "code" character varying NOT NULL, "name" character varying NOT NULL, "description" text NOT NULL, "assessmentId" uuid NOT NULL, "componentId" uuid NOT NULL, "templateSubComponentId" uuid, "translations" jsonb NOT NULL, CONSTRAINT "UQ_cff769b77ac3fefdd946c12084c" UNIQUE ("code", "assessmentId"), CONSTRAINT "PK_8f71c28168394a25295a8b7153d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "countries" ("code" character varying(2) NOT NULL, "name" character varying(100) NOT NULL, "numericCode" character varying(3) NOT NULL, "phoneCode" character varying(10) NOT NULL, "native" character varying(100) NOT NULL, "translations" jsonb NOT NULL DEFAULT '{}', "latitude" character varying(20) NOT NULL, "longitude" character varying(20) NOT NULL, "emoji" character varying(10) NOT NULL, "emojiU" character varying(20) NOT NULL, "description" text, "subregion" character varying(50), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_b47cbb5311bad9c9ae17b8c1eda" PRIMARY KEY ("code"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."assessment_downloads_status_enum" AS ENUM('PENDING', 'PROCESSING', 'READY', 'FAILED')`);
        await queryRunner.query(`CREATE TABLE "assessment_downloads" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "assessmentId" uuid NOT NULL, "domainId" uuid, "userId" uuid NOT NULL, "status" "public"."assessment_downloads_status_enum" NOT NULL DEFAULT 'PENDING', "filePath" text, "errorMessage" text, "jobId" text, CONSTRAINT "PK_f119f5ebcdaef3eb21e5e9f7382" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_45bb14f79539afaaafd2e30b86" ON "assessment_downloads" ("assessmentId") `);
        await queryRunner.query(`CREATE INDEX "IDX_4ead69eb3dfcf2bd8802ff638a" ON "assessment_downloads" ("domainId") `);
        await queryRunner.query(`CREATE INDEX "IDX_d9a6f7a473ebb8cb6f615c52ed" ON "assessment_downloads" ("userId") `);
        ...
        await queryRunner.query(`CREATE TABLE "assessments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "userId" uuid NOT NULL, "name" character varying NOT NULL, "description" text NOT NULL, "countryCode" character varying NOT NULL, "organization" text, "startDate" date NOT NULL, "endDate" date NOT NULL, "status" "public"."assessments_status_enum" NOT NULL DEFAULT 'draft', "isActive" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_a3442bd80a00e9111cefca57f6c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "support_replies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "repliedById" uuid NOT NULL, "description" text NOT NULL, "visibility" "public"."support_replies_visibility_enum" NOT NULL DEFAULT 'public', "priority" "public"."support_replies_priority_enum" NOT NULL DEFAULT 'normal', "status" "public"."support_replies_status_enum" NOT NULL DEFAULT 'open', "supportId" uuid NOT NULL, CONSTRAINT "PK_203c1208336ab63897e4eba3f5e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."supports_status_enum" AS ENUM('open', 'processing', 'close')`);
        await queryRunner.query(`CREATE TABLE "supports" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "title" character varying(255) NOT NULL, "description" text NOT NULL, "issuedById" uuid NOT NULL, "status" "public"."supports_status_enum" NOT NULL DEFAULT 'open', CONSTRAINT "PK_d8c2a7cbebc6494f00dda770105" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "medias" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "filename" character varying NOT NULL, "originalName" character varying NOT NULL, "mimeType" character varying NOT NULL, "size" integer NOT NULL, "path" character varying NOT NULL, "url" character varying NOT NULL, "alt" character varying, "title" character varying, "metadata" jsonb, "storageType" character varying NOT NULL DEFAULT 'local', "entityType" character varying, "entityId" character varying, "isPublic" boolean NOT NULL DEFAULT false, "status" character varying NOT NULL DEFAULT 'active', "createdBy" character varying, "contentHash" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_f27321557a66cd4fae9bc1ed6e7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_5c578cc41ebe249f300015ae50" ON "medias" ("mimeType") `);
        await queryRunner.query(`CREATE INDEX "IDX_d8c7967ef5af0b1a3f5faec7f0" ON "medias" ("storageType") `);
        await queryRunner.query(`CREATE INDEX "IDX_6bfc28fda4308d04af0f375c21" ON "medias" ("entityType", "entityId") `);
        ...
        await queryRunner.query(`ALTER TABLE "assessment_sub_component_roadmaps" ADD CONSTRAINT "FK_9cb9e9b068577c71a9caff370ea" FOREIGN KEY ("roadmapId") REFERENCES "roadmaps"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "assessment_sub_component_roadmaps" ADD CONSTRAINT "FK_9a3cecc1a9a585a1b7d49f16a74" FOREIGN KEY ("subComponentId") REFERENCES "assessment_sub_components"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "assessment_sub_component_roadmaps" ADD CONSTRAINT "FK_c9a1be04953b281fb165942bc56" FOREIGN KEY ("measurementScaleId") REFERENCES "assessment_measurement_scale"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "assessment_sub_component_roadmaps" ADD CONSTRAINT "FK_307c8be05afb36bb5225ed28297" FOREIGN KEY ("answerId") REFERENCES "answers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "roadmaps" ADD CONSTRAINT "FK_84a1a1aa1deaa05869eb59eb445" FOREIGN KEY ("assessmentId") REFERENCES "assessments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "assessment_downloads" ADD CONSTRAINT "FK_45bb14f79539afaaafd2e30b86b" FOREIGN KEY ("assessmentId") REFERENCES "assessments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "assessment_downloads" ADD CONSTRAINT "FK_4ead69eb3dfcf2bd8802ff638a9" FOREIGN KEY ("domainId") REFERENCES "assessment-domains"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "assessment_downloads" ADD CONSTRAINT "FK_d9a6f7a473ebb8cb6f615c52ed6" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "support_replies" ADD CONSTRAINT "FK_34d573a63c55a496d6fbd271341" FOREIGN KEY ("supportId") REFERENCES "supports"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "support_replies" ADD CONSTRAINT "FK_1a6c9179845529d2024982ac501" FOREIGN KEY ("repliedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "supports" ADD CONSTRAINT "FK_8ba7f9d4b7e1bb8ecd708702908" FOREIGN KEY ("issuedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "supports" DROP CONSTRAINT "FK_8ba7f9d4b7e1bb8ecd708702908"`);
        await queryRunner.query(`ALTER TABLE "support_replies" DROP CONSTRAINT "FK_1a6c9179845529d2024982ac501"`);
        await queryRunner.query(`ALTER TABLE "support_replies" DROP CONSTRAINT "FK_34d573a63c55a496d6fbd271341"`);
        ...
        await queryRunner.query(`ALTER TABLE "assessment_downloads" DROP CONSTRAINT "FK_d9a6f7a473ebb8cb6f615c52ed6"`);
        await queryRunner.query(`ALTER TABLE "assessment_downloads" DROP CONSTRAINT "FK_4ead69eb3dfcf2bd8802ff638a9"`);
        await queryRunner.query(`ALTER TABLE "assessment_downloads" DROP CONSTRAINT "FK_45bb14f79539afaaafd2e30b86b"`);
        ...
        await queryRunner.query(`ALTER TABLE "roadmaps" DROP CONSTRAINT "FK_84a1a1aa1deaa05869eb59eb445"`);
        await queryRunner.query(`ALTER TABLE "assessment_sub_component_roadmaps" DROP CONSTRAINT "FK_307c8be05afb36bb5225ed28297"`);
        await queryRunner.query(`ALTER TABLE "assessment_sub_component_roadmaps" DROP CONSTRAINT "FK_c9a1be04953b281fb165942bc56"`);
        await queryRunner.query(`ALTER TABLE "assessment_sub_component_roadmaps" DROP CONSTRAINT "FK_9a3cecc1a9a585a1b7d49f16a74"`);
        await queryRunner.query(`ALTER TABLE "assessment_sub_component_roadmaps" DROP CONSTRAINT "FK_9cb9e9b068577c71a9caff370ea"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_6bfc28fda4308d04af0f375c21"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d8c7967ef5af0b1a3f5faec7f0"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5c578cc41ebe249f300015ae50"`);
        await queryRunner.query(`DROP TABLE "medias"`);
        await queryRunner.query(`DROP TABLE "supports"`);
        await queryRunner.query(`DROP TYPE "public"."supports_status_enum"`);
        await queryRunner.query(`DROP TABLE "support_replies"`);
        await queryRunner.query(`DROP TYPE "public"."support_replies_status_enum"`);
        await queryRunner.query(`DROP TYPE "public"."support_replies_priority_enum"`);
        await queryRunner.query(`DROP TYPE "public"."support_replies_visibility_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_d9a6f7a473ebb8cb6f615c52ed"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_4ead69eb3dfcf2bd8802ff638a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_45bb14f79539afaaafd2e30b86"`);
        await queryRunner.query(`DROP TABLE "assessment_downloads"`);
        await queryRunner.query(`DROP TYPE "public"."assessment_downloads_status_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_29f718c5a5cb41f2266d21ba20"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_84a1a1aa1deaa05869eb59eb44"`);
        await queryRunner.query(`DROP TABLE "roadmaps"`);
        await queryRunner.query(`DROP TYPE "public"."roadmaps_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_307c8be05afb36bb5225ed2829"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c9a1be04953b281fb165942bc5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9a3cecc1a9a585a1b7d49f16a7"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9cb9e9b068577c71a9caff370e"`);
        await queryRunner.query(`DROP TABLE "assessment_sub_component_roadmaps"`);
