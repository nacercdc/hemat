...
> = {
  center: {
    icon: (
      <Icon
        icon="icon-park-outline:center-alignment"
        className="text-dark-light mr-1"
      />
    ),
  ...
  justify: {
    icon: <Icon icon="lucide:align-justify" className="text-dark-light mr-1" />,
  ...
  left: {
    icon: (
      <Icon
        icon="icon-park-outline:left-alignment"
        className="text-dark-light mr-1"
      />
    ),
    iconRTL: "left-align",
  ...
  right: {
    icon: <Icon icon="lucide:align-right" className="text-dark-light mr-1" />,
    iconRTL: "right-align",
    name: "Right Align",
  },
  start: {
...
function BlockFormatDropDown({
  ...
  return (
    ...
    >
      ...
      >
        <div className="icon-text-container flex items-center gap-1">
          <Icon icon="hugeicons:paragraph" />
      ...
      >
        <div className="icon-text-container flex items-center gap-1">
          <Icon icon="heroicons:numbered-list" />
      ...
      >
        <div className="icon-text-container flex items-center gap-1">
          <Icon icon="hugeicons:check-list" />
      ...
      >
        <div className="icon-text-container flex items-center gap-1">
          <Icon icon="fluent:code-block-16-regular" />
...
function getBlockTypeIcon(blockType: keyof typeof blockTypeToBlockName) {
  if (blockType === "h1")
    return <Icon icon="codex:h1" className="text-dark-light mr-1" />;
  if (blockType === "h2")
    return <Icon icon="codex:h2" className="text-dark-light mr-1" />;
  if (blockType === "h3")
    return <Icon icon="codex:h3" className="text-dark-light mr-1" />;
  if (blockType === "number")
    return (
      <Icon icon="heroicons:numbered-list" className="text-dark-light mr-1" />
    );
  if (blockType === "bullet")
    return (
      <Icon
        icon="fluent:text-bullet-list-ltr-20-filled"
        className="text-dark-light mr-1"
      />
    );
  if (blockType === "check")
    return (
      <Icon icon="hugeicons:check-list" className="text-dark-light mr-1" />
    );
  if (blockType === "paragraph")
    return <Icon icon="hugeicons:paragraph" className="text-dark-light mr-1" />;
  if (blockType === "quote")
    return <Icon icon="tabler:quote-filled" className="text-dark-light mr-1" />;
  if (blockType === "code")
    return (
      <Icon
...
function FontDropDown({
  ...
  return (
    <DropDown
      ...
      buttonIcon={
        <Icon icon="mingcute:text-fill" className="text-dark-light mr-1" />
      }
      buttonLabel={value}
      buttonIconClassName={style === "font-family" ? "" : ""}
...
function ElementFormatDropdown({
  ...
  return (
    ...
    >
      ...
      >
        <div className="icon-text-container flex items-center gap-1">
          <Icon icon="icon-park-outline:left-alignment" />
      ...
      >
        <div className="icon-text-container flex items-center gap-1">
          <Icon icon="icon-park-outline:center-alignment" />
    ...
    <div className="toolbar">
      ...
      {toolbarState.blockType === "code" ? (
        ...
        <>
          ...
          >
            <Icon icon="octicon:bold-24" className="text-dark-light" />
          </button>
          <button
            disabled={!isEditable}
            onClick={() => {
          ...
          >
            <Icon icon="uil:italic" className="text-dark-light !w-5 !h-5" />
          </button>
          <button
            disabled={!isEditable}
            onClick={() => {
          ...
          >
            <Icon icon="uil:underline" className="text-dark-light !w-5 !h-5" />
          </button>
          {canViewerSeeInsertCodeButton && (
            ...
            >
              <Icon
                ...
                className="text-dark-light !w-5 !h-5"
              />
            </button>
          )}
          <DropDown
            ...
            buttonIcon={
              <Icon
                ...
                className="!h-6 !w-6 text-dark-light mr-2"
              />
            }
          ...
          >
            ...
            >
              <div className="icon-text-container flex items-center gap-1">
                <Icon icon="proicons:text-case-lowercase" />
            ...
            >
              <div className="icon-text-container flex items-center gap-1">
                <Icon icon="proicons:text-case-uppercase" />
